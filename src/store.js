const NEW_ROW = 'NEW_ROW'; //names of actions
...
export const store = {
  ...
  dispatch(action) {
    switch (action.type) {
      case NEW_ROW:
        this.newItem.name = action.name
        this.newItem.date = action.date
        this.newItem.days = action.days
        this.newItem.mission = action.mission
